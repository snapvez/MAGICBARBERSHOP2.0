...
interface AuthContextType {
  ...
  profile: any | null;
  signUpGuest: (fullName: string, phone: string, email?: string) => Promise<void>;
...
export const AuthProvider = ({ children }: { children: React.ReactNode }) => {
  ...
  const signUpGuest = async (fullName: string, phone: string, email?: string) => {
  ...
  return (
    <AuthContext.Provider value={{ user, loading, isAdmin, isSuperAdmin, adminBarberId, profile, signUpGuest, signInGuest, signUp, signIn, signOut }}>
      {children}
