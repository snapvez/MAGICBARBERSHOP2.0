...
import { Calendar, Users, TrendingUp, Award, CalendarDays, Phone, Mail, Crown, Ban, CheckCircle, DollarSign, Clock, CalendarClock, FileDown, Trophy } from 'lucide-react';
...
export const AdminDashboard = ({ onNavigate }: AdminDashboardProps) => {
  ...
  const [viewMode, setViewMode] = useState<'appointments' | 'clients' | 'revenue' | 'points' | 'qrcode' | 'analytics'>('appointments');
