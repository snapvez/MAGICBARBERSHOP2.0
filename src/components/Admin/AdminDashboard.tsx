...
import { Calendar, Users, TrendingUp, Award, CalendarDays, Phone, Mail, Crown, Ban, CheckCircle, DollarSign, Clock, CalendarClock, FileDown, Trophy, FolderOpen, Settings, UserCog, Scissors } from 'lucide-react';
...
export const AdminDashboard = ({ onNavigate }: AdminDashboardProps) => {
  ...
  const [viewMode, setViewMode] = useState<'appointments' | 'clients' | 'revenue' | 'points' | 'qrcode' | 'analytics' | 'categories' | 'settings' | 'professionals' | 'services' | 'schedules'>('appointments');
