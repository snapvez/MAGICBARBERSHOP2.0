...
export function SubscriptionPlansManager() {
  ...
  const handleAdd = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setFormData({ name: '', price: 0, cuts_per_month: 1, description: '', stripe_payment_link: '' });
      fetchPlans();
    } catch (error) {
          ...
          <table className="w-full">
            <thead>
              <tr className="bg-gray-800 border-b-2 border-magic-gold/30">
                ...
                <th className="px-4 py-3 text-center text-sm font-semibold text-magic-gold">Cortes/Mês</th>
