...
function App() {
  ...
  const renderPage = () => {
    ...
    if (isAdmin && (currentPage === 'admin' || currentPage === 'admin-calendar' || currentPage === 'barber-schedule' || currentPage === 'schedule-manager' || currentPage === 'commissions' || currentPage === 'barbers' || currentPage === 'subscription-plans' || currentPage === 'clients-list' || currentPage === 'today-appointments' || currentPage === 'revenue-details' || currentPage === 'all-appointments' || currentPage === 'active-subscriptions' || currentPage === 'active-services')) {
      if (currentPage === 'admin-calendar') {
        return <AdminCalendar onNavigate={setCurrentPage} />;
      }
      if (currentPage === 'barber-schedule') {
